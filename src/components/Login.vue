  ...
  <div class="login_container">
    ...
    <div class="login_box">
      ...
      <div class="avatar_box">
        <img src="https://cdn.staticaly.com/gh/xin0710/picture@master/img/zuo.png" alt="" />
      </div>
      <!-- 登录表单区域 -->
...
.login_container {
  ...
  background: url(https://cdn.staticaly.com/gh/xin0710/picture@master/img/j3.png) no-repeat 0px 0px;
