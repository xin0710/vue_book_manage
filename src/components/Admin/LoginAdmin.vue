  ...
  <div class="login_container">
    ...
    <div class="login_box">
      ...
      <div class="avatar_box">
        <img src="https://cdn.staticaly.com/gh/xin0710/picture@master/img/xin.jpg" alt="" />
      </div>
      <!-- 登录表单区域 -->
      <el-form
        ref="loginFormRef"
...
.login_container {
  ...
  background: url(https://cdn.staticaly.com/gh/xin0710/picture@master/img/n1.png) no-repeat
    0px 0px;
