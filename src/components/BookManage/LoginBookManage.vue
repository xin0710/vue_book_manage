  ...
  <div class="login_container">
    ...
    <div class="login_box">
      ...
      <div class="avatar_box">
        <img
          src="https://cdn.staticaly.com/gh/xin0710/picture@master/img/hao.jpg"
          alt=""
        />
      </div>
      <!-- 登录表单区域 -->
...
.login_container {
  ...
  background: url(https://cdn.staticaly.com/gh/xin0710/picture@master/img/blog8.jpg) no-repeat
    0px 0px;
